const habitConsistencyReport = require('./habitConsistency.report');
const weeklyTrendReport = require('./weeklyTrend.report');
const habitStreakReport = require('./habitStreak.report');
